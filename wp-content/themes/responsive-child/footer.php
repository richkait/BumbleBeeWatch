...
<div id="footer-background">
    ...
    <div id="footer" class="clearfix">
        ...
        <div id="footer-wrapper">
            ...
            <div class="grid col-940" style="padding:20px;">
            
                <div class="grid col-300"><!-- Footer nav-->
    		      <?php if (has_nav_menu('footer-menu', 'responsive')) { ?>
    		    	 ...
    		    	 ?>
                    <?php } ?>
                </div><!-- end of col-300 footer nav -->
    
                <div class="grid col-300"><!-- Blurb -->
                    <h4 style="margin-top:0px;">About Bumble Bee Watch</h4>
                    <p>Bumble Bee Watch is a citizen science project through the partnership of <a href="">The Xerces Society</a>, <a href="">the University of Ottawa</a>, <a href="">Wildlife Preservation Canada</a>, and <a href="">the Montreal Insectarium</a>. <a href="">Learn more about this project here.</a></p>
                </div><!-- end of  col-300 blurb -->
                 
                <div class="grid col-300 fit"><!-- Social Media Icons -->
                    <h4 style="margin-top:0px;">Stay in touch</h4>
                    <?php
            ...
            <div class="grid col-300 fit powered">
                <a href="<?php echo esc_url(__('http://themeid.com/responsive-theme/','responsive')); ?>" title="<?php esc_attr_e('Responsive Theme', 'responsive'); ?>">
                        <?php printf('A Responsive Child Theme'); ?></a>
